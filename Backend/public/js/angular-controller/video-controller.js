system.controller("VideoController", VideoController);
/**
 *
 * @param {type} $scope
 * @param {type} $http
 ...
 * @returns {undefined}
 */
function VideoController($scope, $http, $rootScope, $timeout, $interval) {
    this.__proto__ = BaseController($scope, $http, $rootScope);
    $scope.controllerName = "VideoController";
